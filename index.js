...
model1.compile({optimizer: 'sgd', loss: 'meanSquaredError'});
...
btn.addEventListener('click',()=>{
  ...
  let result = model1.predict(tf.tensor2d([[parseInt(data)]], [1, 1]));
  let ans = document.getElementById('answer');
  ans.innerHTML = "result is : "+ result; 
